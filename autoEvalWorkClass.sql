...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$100000$ZjzsEIPuyBMR$zS1mzJtHXNZq/y/oTU+oSXa70/9RGLUtuY/cS4BEHNA=','2018-03-29 22:42:10.107536',1,'fx1','','','fx1@gmail.com',1,1,'2018-03-29 22:41:36.699485');
...
INSERT INTO `django_session` VALUES ('zxghk2h942ga5mgnzmjj8gcmt8fmuprn','NTZjYjE1NmI5NGEyZjRlMjhiZWFjOWFkYTRkZmIxZmJhZmRmMmJhZTp7Il9hdXRoX3VzZXJfYmFja2VuZCI6ImRqYW5nby5jb250cmliLmF1dGguYmFja2VuZHMuTW9kZWxCYWNrZW5kIiwiX2F1dGhfdXNlcl9pZCI6IjEiLCJfYXV0aF91c2VyX2hhc2giOiIyYjIwNDdhY2YxOWZhYmYwMzE5MDJmMWJkYWI0MjllYTVkOWM5ZGIzIn0=','2018-04-12 22:42:10.111074');
...
INSERT INTO `workClass_docente` VALUES (1,'Pedro','Rojas',30,'123456789','pedro@gmail.com','Activo');
...
INSERT INTO `workClass_estudiante` VALUES (1,'Carlos','Blanco',23,'987654321','carlos@gmail.com','Activo',1);
...
INSERT INTO `workClass_intensidad` VALUES (1,3,6);
...
CREATE TABLE `workClass_sesion` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `intensidad_id` (`intensidad_id`),
...
INSERT INTO `workClass_sesion` VALUES (1,'1','Poblado','Martes-Miercoles','Ingles',1,1);
...
INSERT INTO `workClass_video` VALUES (1,'2018-07-29',10,'mp4','feliz','video1.mp4',1),(2,'2018-06-29',20,'mp4','aburrido','video2.mp4',1),(3,'2018-05-29',30,'mp4','bravo','video3.mp4',1),(4,'2018-04-29',40,'mp4','deprimido','video4.mp4',1),(5,'2018-02-20',50,'mp4','ocioso','video5.mp4',1),(6,'2018-03-29',10,'mp4','serio','video6.mp4',1);
...
-- Dump completed on 2018-03-29 20:17:43
