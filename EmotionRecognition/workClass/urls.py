...
urlpatterns = [
        ...
        path('<int:docente_id>/estadisticas_docente/', views.estadisticas_docente, name='estadisticas_docente'),
        path('<int:grafica_id>/estadisticas_grafica/', views.estadisticas_grafica, name='estadisticas_grafica'),
